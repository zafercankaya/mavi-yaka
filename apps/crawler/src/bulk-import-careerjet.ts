...
const MARKET_CONFIGS: MarketConfig[] = [
  ...
  },
  {
    ...
    keywords: ['물류창고', '지게차', '운전기사', '청소', '조리',
      ...
      '경비', '택배', '배달', '정비사', '요양보호사',
      '포장', '하역', '배관공', '도장공', '목수',
      '미장공', '철근공', '타일공', '방수공', '보일러기사',
      '크레인기사', '굴삭기기사', '제조', '공장', '생산',
      '식당보조', '주방보조', '호텔청소', '경비원', '환경미화원',
      '카페알바', '편의점', '마트직원', '주유소', '세차',
      '농장', '축산', '수산', '어업', '양식'],
  },
  {
  ...
  },
  {
    ...
    keywords: ['พนักงานคลังสินค้า', 'พนักงานขับรถ', 'แม่บ้าน', 'พ่อครัว',
      ...
      'ช่างแอร์', 'ช่างประปา', 'ช่างยนต์', 'ช่างสี', 'ช่างไม้',
      'พนักงานบรรจุ', 'พนักงานขนส่ง', 'คนขับรถบรรทุก', 'คนขับรถส่งของ',
      'พนักงานโรงงาน', 'พนักงานทำความสะอาด', 'พนักงานรักษาความปลอดภัย',
      'พนักงานโรงแรม', 'พนักงานร้านอาหาร', 'กุ๊ก', 'ผู้ช่วยพ่อครัว',
      'ช่างเทคนิค', 'ช่างกล', 'พนักงานเกษตร', 'คนสวน', 'ช่างเหล็ก',
      'พนักงานปั๊มน้ำมัน', 'พนักงานล้างรถ', 'พนักงานแพ็คสินค้า'],
  },
  {
    ...
    keywords: ['công nhân kho', 'tài xế', 'lao công', 'đầu bếp',
      ...
      'lao động phổ thông', 'thợ máy', 'giao hàng', 'vận chuyển',
      'may mặc', 'lắp ráp', 'bảo trì', 'cơ khí', 'nhà hàng',
      'khách sạn', 'nông nghiệp', 'chăn nuôi', 'thợ sơn',
      'thợ mộc', 'thợ ống nước', 'kho vận', 'sản xuất'],
  },
  {
  ...
  },
  {
    ...
    keywords: ['warehouse helper', 'driver', 'cleaner', 'cook', 'factory worker',
      ...
      'delivery rider', 'carpenter', 'painter', 'steel fixer', 'ac technician',
      'hotel staff', 'waiter', 'kitchen helper', 'housekeeping', 'watchman',
      'textile worker', 'stitching operator', 'machine operator', 'loader',
      'sweeper', 'farm worker', 'tractor driver', 'auto electrician',
      'bike rider', 'dispatch rider', 'office boy', 'production worker',
      'crane operator', 'forklift operator', 'construction labourer'],
  },
  {
