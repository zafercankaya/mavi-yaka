...
const WHITE_COLLAR_KEYWORDS = [
  ...
  'sachbearbeiter', 'sachbearbeiterin', 'sozialpädagoge', 'sozialpädagogin',
  'sozialarbeiter', 'sozialarbeiterin', 'erzieher', 'erzieherin',
  'pädagoge', 'pädagogin', 'psychologe', 'psychologin',
  'bauingenieur', 'wirtschaftsingenieur', 'ingenieur',
  'personalreferent', 'personalreferentin', 'personalsachbearbeiter',
  'bilanzbuchhalter', 'finanzbuchhalter', 'steuerfachangestellte',
  'fachinformatiker', 'systemadministrator', 'netzwerkadministrator',
  'architekt', 'architektin', 'innenarchitekt',
  'redakteur', 'journalist', 'lektor',
  'dozent', 'dozentin', 'professor', 'professorin',
  'wissenschaftlicher mitarbeiter', 'wissenschaftliche mitarbeiterin',
  'kaufmann', 'kauffrau', 'bankkaufmann', 'bankkauffrau',
  'versicherungskaufmann', 'industriekaufmann', 'bürokaufmann',
  // Portuguese
