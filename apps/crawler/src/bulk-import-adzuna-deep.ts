...
const MARKET_CONFIGS: MarketConfig[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      'line worker', 'boiler operator', 'boiler technician',
      ...
      'paver', 'concrete finisher', 'sheet metal worker', 'millwright',
      ...
      'parking attendant', 'valet', 'window cleaner',
      'power washer', 'pressure washer operator', 'waste sorter',
      'demolition worker', 'flagger',
